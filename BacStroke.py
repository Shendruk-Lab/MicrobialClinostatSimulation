...
def save_run(traj, output_folder):
    ...
    filepath = os.path.join(output_folder, "run_2.csv")
...
output_folder = 'C:/Users/Kenzie/Documents/Education/Edinburgh_University/Summer_Masters/BacStroke/numba_test_results'
